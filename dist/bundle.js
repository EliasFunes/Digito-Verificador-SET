...
var _digitoVerificador = __webpack_require__(3);

var _digitoVerificador2 = _interopRequireDefault(_digitoVerificador);
...
function Pa_Calcular_Dv_11_A(p_numero) {
    var p_basemax = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 11;
...
module.exports = function generarRucDigitoVerificador(numero) {
    return Pa_Calcular_Dv_11_A(numero);
};
